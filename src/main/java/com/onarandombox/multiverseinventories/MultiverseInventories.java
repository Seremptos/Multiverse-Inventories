                ...
                filesList.forEach(file -> {
                    ...
                    try {
                        ...
                        if (player.getName() == null) {
                            Logging.getLogger().info(presumedUUID + " doesn't look like a playername, this file won't be converted.");
                        }
                        if (file.toFile().renameTo(new File(file.getParent().toFile(), player.getUniqueId() + ".json"))) {
                            Logging.getLogger().info("Successfully renamed player " + presumedUUID + " in folder "+file.getParent().toFile().getName()+" to UUID " + player.getUniqueId() + ".");
                        } else {
                            Logging.getLogger().info("Failed renaming player " + presumedUUID + " in folder "+file.getParent().toFile().getName()+" to UUID " + player.getUniqueId() + ".");
                        }
                    }
                });
